...
public static class Equals
{
	...
	public static class Methods
	{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool Sbyte(sbyte x, sbyte y) => x == y;
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool Bool(bool x, bool y) => x == y;

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool Ushort(ushort x, ushort y) => x == y;

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool Short(short x, short y) => x == y;

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool Long(long x, long y) => x == y;

		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool Ulong(ulong x, ulong y) => x == y;
