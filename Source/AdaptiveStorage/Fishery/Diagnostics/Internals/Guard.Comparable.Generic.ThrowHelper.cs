	...
	private partial class ThrowHelper
	{
		...
		public static void ThrowArgumentExceptionForIsDefault<T>(T value, string name)
			...
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must be the default value {AssertString(default(T))}, was {AssertString(value)}.",
				name);
		...
		public static void ThrowArgumentExceptionForIsNotDefault<T>(string name)
			where T : struct
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must not be the default value {AssertString(default(T))}.",
				name);
		...
		public static void ThrowArgumentExceptionForIsEqualTo<T>(T value, T target, string name)
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must be equal to {AssertString(target)}, was {AssertString(value)}.",
				name);
		...
		public static void ThrowArgumentExceptionForIsNotEqualTo<T>(T value, T target, string name)
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must not be equal to {AssertString(target)}, was {AssertString(value)}.",
				name);
		...
		public static void ThrowArgumentExceptionForBitwiseEqualTo<T>(T value, T target, string name)
			where T : unmanaged
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) is not a bitwise match, was <{value.ToHexString()}> instead of <{target.ToHexString()}>.",
				name);
		...
		public static void ThrowArgumentOutOfRangeExceptionForIsLessThan<T>(T value, T maximum, string name)
			=> throw new ArgumentOutOfRangeException(name, value!,
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must be less than {AssertString(maximum)}, was {AssertString(value)}.");
		...
		public static void ThrowArgumentOutOfRangeExceptionForIsLessThanOrEqualTo<T>(T value, T maximum, string name)
			=> throw new ArgumentOutOfRangeException(name, value!,
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must be less than or equal to {AssertString(maximum)}, was {AssertString(value)}.");
		...
		public static void ThrowArgumentOutOfRangeExceptionForIsGreaterThan<T>(T value, T minimum, string name)
			=> throw new ArgumentOutOfRangeException(name, value!,
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must be greater than {AssertString(minimum)}, was {AssertString(value)}.");
		...
		public static void ThrowArgumentOutOfRangeExceptionForIsGreaterThanOrEqualTo<T>(T value, T minimum, string name)
			=> throw new ArgumentOutOfRangeException(name, value!,
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must be greater than or equal to {AssertString(minimum)}, was {AssertString(value)}.");
		...
		public static void ThrowArgumentOutOfRangeExceptionForIsInRange<T>(T value, T minimum, T maximum, string name)
			=> throw new ArgumentOutOfRangeException(name, value!,
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must be in the range given by {AssertString(minimum)} and {AssertString(maximum)}, was {AssertString(value)}.");
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		public static void
			ThrowArgumentOutOfRangeExceptionForIsNotInRange<T>(T value, T minimum, T maximum, string name)
			=> throw new ArgumentOutOfRangeException(name, value!,
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must not be in the range given by {AssertString(minimum)} and {AssertString(maximum)}, was {AssertString(value)}.");
		...
		public static void ThrowArgumentOutOfRangeExceptionForIsBetween<T>(T value, T minimum, T maximum, string name)
			=> throw new ArgumentOutOfRangeException(name, value!,
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must be between {AssertString(minimum)} and {AssertString(maximum)}, was {AssertString(value)}.");
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		public static void
			ThrowArgumentOutOfRangeExceptionForIsNotBetween<T>(T value, T minimum, T maximum, string name)
			=> throw new ArgumentOutOfRangeException(name, value!,
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must not be between {AssertString(minimum)} and {AssertString(maximum)}, was {AssertString(value)}.");
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		public static void
			ThrowArgumentOutOfRangeExceptionForIsBetweenOrEqualTo<T>(T value, T minimum, T maximum, string name)
			=> throw new ArgumentOutOfRangeException(name, value!,
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must be between or equal to {AssertString(minimum)} and {AssertString(maximum)}, was {AssertString(value)}.");
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		public static void
			ThrowArgumentOutOfRangeExceptionForIsNotBetweenOrEqualTo<T>(T value, T minimum, T maximum, string name)
			=> throw new ArgumentOutOfRangeException(name, value!,
				$"Parameter {AssertString(name)} ({typeof(T).ToTypeString()}) must not be between or equal to {AssertString(minimum)} and {AssertString(maximum)}, was {AssertString(value)}.");
	}
}
