	...
	private partial class ThrowHelper
	{
		...
		public static void ThrowArgumentExceptionForIsNullOrEmpty(string? text, string name)
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} (string) must be null or empty, was {AssertString(text)}.", name);
			...
			static Exception GetException(string? text, string name)
				=> text is null
					? new ArgumentNullException(name,
						$"Parameter {AssertString(name)} (string) must not be null or empty, was null.")
					: new ArgumentException(
						$"Parameter {AssertString(name)} (string) must not be null or empty, was empty.", name);
		...
		public static void ThrowArgumentExceptionForIsNullOrWhiteSpace(string? text, string name)
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} (string) must be null or whitespace, was {AssertString(text)}.", name);
		...
		public static void ThrowArgumentExceptionForIsNotNullOrWhiteSpace(string? text, string name)
		{
			...
			static Exception GetException(string? text, string name)
				=> text is null
					? new ArgumentNullException(name,
						$"Parameter {AssertString(name)} (string) must not be null or whitespace, was null.")
					: new ArgumentException(
						$"Parameter {AssertString(name)} (string) must not be null or whitespace, was whitespace.",
						name);
		...
		public static void ThrowArgumentExceptionForIsEmpty(string text, string name)
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} (string) must be empty, was {AssertString(text)}.", name);
		...
		public static void ThrowArgumentExceptionForIsWhiteSpace(string text, string name)
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} (string) must be whitespace, was {AssertString(text)}.", name);
		...
		public static void ThrowArgumentExceptionForIsNotWhiteSpace(string text, string name)
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} (string) must not be whitespace, was {AssertString(text)}.", name);
		...
		public static void ThrowArgumentExceptionForHasSizeEqualTo(string text, int size, string name)
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} (string) must have a size equal to {size}, had a size of {text.Length} and was {AssertString(text)}.",
				name);
		...
		public static void ThrowArgumentExceptionForHasSizeNotEqualTo(string text, int size, string name)
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} (string) must not have a size equal to {size}, was {AssertString(text)}.",
				name);
		...
		public static void ThrowArgumentExceptionForHasSizeGreaterThan(string text, int size, string name)
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} (string) must have a size over {size}, had a size of {text.Length} and was {AssertString(text)}.",
				name);
		...
		public static void ThrowArgumentExceptionForHasSizeGreaterThanOrEqualTo(string text, int size, string name)
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} (string) must have a size of at least {size}, had a size of {text.Length} and was {AssertString(text)}.",
				name);
		...
		public static void ThrowArgumentExceptionForHasSizeLessThan(string text, int size, string name)
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} (string) must have a size less than {size}, had a size of {text.Length} and was {AssertString(text)}.",
				name);
		...
		public static void ThrowArgumentExceptionForHasSizeLessThanOrEqualTo(string text, int size, string name)
			=> throw new ArgumentException(
				$"Parameter {AssertString(name)} (string) must have a size less than or equal to {size}, had a size of {text.Length} and was {AssertString(text)}.",
				name);
		...
		public static void ThrowArgumentExceptionForHasSizeEqualTo(string source, string destination, string name)
			=> throw new ArgumentException(
				$"The source {AssertString(name)} (string) must have a size equal to {AssertString(destination.Length)} (the destination), had a size of {AssertString(source.Length)}.",
				name);
		...
		[DoesNotReturn]
		public static void
			ThrowArgumentExceptionForHasSizeLessThanOrEqualTo(string source, string destination, string name)
			=> throw new ArgumentException(
				$"The source {AssertString(name)} (string) must have a size less than or equal to {AssertString(destination.Length)} (the destination), had a size of {AssertString(source.Length)}.",
				name);
		...
		public static void ThrowArgumentOutOfRangeExceptionForIsInRangeFor(int index, string text, string name)
			=> throw new ArgumentOutOfRangeException(name, index,
				$"Parameter {AssertString(name)} (int) must be in the range given by <0> and {AssertString(text.Length)} to be a valid index for the target string, was {AssertString(index)}.");
		...
		public static void ThrowArgumentOutOfRangeExceptionForIsNotInRangeFor(int index, string text, string name)
			=> throw new ArgumentOutOfRangeException(name, index,
				$"Parameter {AssertString(name)} (int) must not be in the range given by <0> and {AssertString(text.Length)} to be an invalid index for the target string, was {AssertString(index)}.");
	}
}