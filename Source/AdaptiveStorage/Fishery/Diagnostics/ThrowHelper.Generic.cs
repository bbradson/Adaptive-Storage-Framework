...
public static partial class ThrowHelper
{
	...
	[DoesNotReturn]
	public static T ThrowArrayTypeMismatchException<T>() => throw new ArrayTypeMismatchException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowArgumentException<T>() => throw new ArgumentException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowArgumentNullException<T>() => throw new ArgumentNullException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowArgumentNullException<T>(string? name) => throw new ArgumentNullException(name);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowArgumentOutOfRangeException<T>() => throw new ArgumentOutOfRangeException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowArgumentOutOfRangeException<T>(string? name) => throw new ArgumentOutOfRangeException(name);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowCOMException<T>() => throw new COMException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowCOMException<T>(string? message) => throw new COMException(message);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowCOMException<T>(string? message, int error) => throw new COMException(message, error);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowExternalException<T>() => throw new ExternalException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowExternalException<T>(string? message) => throw new ExternalException(message);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowFormatException<T>() => throw new FormatException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowFormatException<T>(string? message) => throw new FormatException(message);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowInsufficientMemoryException<T>() => throw new InsufficientMemoryException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowInvalidDataException<T>() => throw new InvalidDataException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowInvalidDataException<T>(string? message) => throw new InvalidDataException(message);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowLockRecursionException<T>() => throw new LockRecursionException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowLockRecursionException<T>(string? message) => throw new LockRecursionException(message);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowMissingFieldException<T>() => throw new MissingFieldException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowMissingFieldException<T>(string? message) => throw new MissingFieldException(message);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowMissingMemberException<T>() => throw new MissingMemberException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowMissingMemberException<T>(string? message) => throw new MissingMemberException(message);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowMissingMethodException<T>() => throw new MissingMethodException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowMissingMethodException<T>(string? message) => throw new MissingMethodException(message);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowNotSupportedException<T>() => throw new NotSupportedException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowNotSupportedException<T>(string? message) => throw new NotSupportedException(message);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowOperationCanceledException<T>() => throw new OperationCanceledException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowPlatformNotSupportedException<T>() => throw new PlatformNotSupportedException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowSynchronizationLockException<T>() => throw new SynchronizationLockException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowTimeoutException<T>() => throw new TimeoutException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowTimeoutException<T>(string? message) => throw new TimeoutException(message);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowUnauthorizedAccessException<T>() => throw new UnauthorizedAccessException();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowWin32Exception<T>() => throw new Win32Exception();
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowWin32Exception<T>(int error) => throw new Win32Exception(error);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowWin32Exception<T>(int error, string? message) => throw new Win32Exception(error, message);
	...
	/// <returns>This method always throws, so it actually never returns a value.</returns>
	[DoesNotReturn]
	public static T ThrowWin32Exception<T>(string? message) => throw new Win32Exception(message);
