...
public partial class Guard
{
	private partial class ThrowHelper
	{
		...
		/// <summary>
		/// Throws an <see cref="ArgumentException"/> when <see cref="IsCloseTo(IntPtr,IntPtr,UIntPtr,string)"/> fails.
		/// </summary>
		[DoesNotReturn]
		...
		/// <summary>
		/// Throws an <see cref="ArgumentException"/> when <see cref="IsNotCloseTo(IntPtr,IntPtr,UIntPtr,string)"/> fails.
		/// </summary>
		[DoesNotReturn]
