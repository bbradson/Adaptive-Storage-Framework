...
public static partial class ThrowHelper
{
	...
	[DoesNotReturn]
	public static void ThrowCOMException() => throw new COMException();
	...
	[DoesNotReturn]
	public static void ThrowCOMException(string? message) => throw new COMException(message);
	...
	/// <exception cref="COMException">Thrown with the specified parameters.</exception>
	[DoesNotReturn]
	public static void ThrowCOMException(string? message, int error) => throw new COMException(message, error);
	...
	[DoesNotReturn]
	public static void ThrowExternalException() => throw new ExternalException();
	...
	[DoesNotReturn]
	public static void ThrowExternalException(string? message) => throw new ExternalException(message);
	...
	[DoesNotReturn]
	public static void ThrowFormatException(string? message) => throw new FormatException(message);
	...
	[DoesNotReturn]
	public static void ThrowInsufficientMemoryException() => throw new InsufficientMemoryException();
	...
	[DoesNotReturn]
	public static void ThrowInvalidDataException() => throw new InvalidDataException();
	...
	[DoesNotReturn]
	public static void ThrowLockRecursionException() => throw new LockRecursionException();
	...
	[DoesNotReturn]
	public static void ThrowLockRecursionException(string? message) => throw new LockRecursionException(message);
	...
	[DoesNotReturn]
	public static void ThrowMissingFieldException() => throw new MissingFieldException();
	...
	[DoesNotReturn]
	public static void ThrowMissingFieldException(string? message) => throw new MissingFieldException(message);
	...
	[DoesNotReturn]
	public static void ThrowMissingMemberException() => throw new MissingMemberException();
	...
	[DoesNotReturn]
	public static void ThrowMissingMemberException(string? message) => throw new MissingMemberException(message);
	...
	[DoesNotReturn]
	public static void ThrowMissingMethodException() => throw new MissingMethodException();
	...
	[DoesNotReturn]
	public static void ThrowMissingMethodException(string? message) => throw new MissingMethodException(message);
	...
	[DoesNotReturn]
	public static void ThrowSynchronizationLockException() => throw new SynchronizationLockException();
	...
	[DoesNotReturn]
	public static void ThrowTimeoutException(string? message) => throw new TimeoutException(message);
	...
	[DoesNotReturn]
	public static void ThrowUnauthorizedAccessException() => throw new UnauthorizedAccessException();
	...
	[DoesNotReturn]
	public static void ThrowWin32Exception() => throw new Win32Exception();
	...
	[DoesNotReturn]
	public static void ThrowWin32Exception(int error) => throw new Win32Exception(error);
	...
	/// <exception cref="Win32Exception">Thrown with the specified parameter.</exception>
	[DoesNotReturn]
	public static void ThrowWin32Exception(int error, string? message) => throw new Win32Exception(error, message);
	...
	/// <exception cref="Win32Exception">Thrown with the specified parameter.</exception>
	[DoesNotReturn]
	public static void ThrowWin32Exception(string? message) => throw new Win32Exception(message);
